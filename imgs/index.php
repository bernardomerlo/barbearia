    ...
    <form method="POST" action="">
        ...
        <select name="id_barbeiro" id="id_barbeiro" required onchange="atualizarHorarios()">
            ...
            foreach ($barbeiros as $barbeiro) {
                echo "<option value='" . htmlspecialchars($barbeiro->id) . "' data-foto='" . htmlspecialchars($barbeiro->foto) . "'>" . $barbeiro->nome . "</option>";
            }
            ?>
        </select>
        ...
        <select name="tipo_corte" id="tipo_corte" required>
            ...
            foreach ($tipos_corte as $tipo_corte) {
                echo "<option value='" . htmlspecialchars($tipo_corte->id) . "'>" . $tipo_corte->nome . "</option>";
            }
            ?>
        </select>
